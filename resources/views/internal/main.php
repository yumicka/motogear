...
<html lang="<?=Arr::get($state, 'ui.currentLang', 'en')?>">
    <head>
        ...
        <link rel="stylesheet" href="<?=asset("dist/main.css")."?version=".config("configuration.version")?>" data-id="main"> 
    ...
    <body>
        ...
        <div id="app"></div>
        <script src="<?=asset("dist/main.js")."?version=".config("configuration.version")?>" defer data-id="main"></script>   
