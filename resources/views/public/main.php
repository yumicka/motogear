...
<html lang="<?=Arr::get($state, 'ui.currentLang', 'en')?>">
    <head>
        ...
        <link rel="stylesheet" href="<?=asset("dist/public.css")."?version=".config("configuration.version")?>" data-id="public"> 
    ...
    <body>
        ...
        <div id="app"></div>
        <script src="<?=asset("dist/public.js")."?version=".config("configuration.version")?>" defer data-id="public"></script>   
