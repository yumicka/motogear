<?php
    ...
    use Illuminate\Support\Arr; // Correctly use the Arr class
...
<body>
    ...
    <div class="container">
        <div class="top-line"><?=$company_requisites['company_name']?>, <?=$company_requisites['physical_address']?></div>
        <div><?=Arr::get($fields[2], 'name')?> <?=Arr::get($fields[3], 'last_name')?></div>
