        ...
        $actions = [
            ...
            'create' => [        
                ...
                //<editor-fold defaultstate="collapsed" desc="create">
                    $meta_data = MetaDataModel::whereContainerIdAndContainerName($request->container_id, $request->container_name)->first();
                    
                    if (!empty($meta_data)) {
                        return Response::error("MetaData with name:{$request->container_name} already exists!");
                    }              
                    
                    $meta_data = MetaData::create($request->container_name, $request->container_id);
            ...
            'delete' => [        
                ...
                //<editor-fold defaultstate="collapsed" desc="delete"> 
                    ...
                    MetaData::delete($meta_data);

                    return Response::success([                        
                        'msg' => 'Metadata is deleted!'
                    ]);                     
                //</editor-fold>     
                },
            ],                         
