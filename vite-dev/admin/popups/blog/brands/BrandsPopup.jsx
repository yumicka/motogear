...
const containerName = 'BrandsAdministration';
const popupName = 'brands';
const tableName = 'dt_brands';
const url = 'administration/blog/brands/actions';
...
class BrandsPopup extends Component {
	constructor(props) {
		super(props);
...
BrandsPopup.propTypes = propTypes;

BrandsPopup.defaultProps = defaultProps;
