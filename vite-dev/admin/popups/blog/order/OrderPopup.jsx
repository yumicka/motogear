...
const containerName = 'OrderAdministration';
const popupName = 'orders';
const tableName = 'dt_orders';
const url = 'administration/blog/orders/actions';
...
OrderPopup.propTypes = propTypes;

OrderPopup.defaultProps = defaultProps;
