...
const containerName = 'DeliveryAdministration';
const popupName = 'delivery';
const tableName = 'delivery_companies';
const url = 'administration/blog/delivery/actions';
...
class DeliveryPopup extends Component {
	...
	getTitle = (data) => {
		...
		return `Piegādes pārvadātāja ieraksts #${id}`;
		//</editor-fold>
	};
...
DeliveryPopup.propTypes = propTypes;

DeliveryPopup.defaultProps = defaultProps;
