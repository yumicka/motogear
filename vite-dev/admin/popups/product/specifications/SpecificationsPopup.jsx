...
const containerName = 'SpecificationsAdministration';
const popupName = 'specifications';
const tableName = 'dt_specifications';
const url = 'administration/blog/specifications/actions';
...
class SpecificationsPopup extends Component {
	constructor(props) {
		super(props);
	...
	getTitle = (data) => {
		...
		return `Produkta specifikacija #${id}`;
		//</editor-fold>
	};
...
SpecificationsPopup.propTypes = propTypes;

SpecificationsPopup.defaultProps = defaultProps;
