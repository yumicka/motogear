...
const containerName = 'ExpensesAdministration';
const popupName = 'expenses';
const tableName = 'dt_expenses';
const url = 'administration/expenses/actions';
...
class ExpensesPopup extends Component {
	constructor(props) {
		super(props);
...
ExpensesPopup.propTypes = propTypes;

ExpensesPopup.defaultProps = defaultProps;
