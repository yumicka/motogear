...
class BottomRightCard extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="bottom_right_card">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
BottomRightCard.propTypes = propTypes;

BottomRightCard.defaultProps = defaultProps;

BottomRightCard = WithUi(uiProps)(BottomRightCard);
