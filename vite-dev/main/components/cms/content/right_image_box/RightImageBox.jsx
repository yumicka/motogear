...
class RightImageBox extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="right_image_box">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
RightImageBox.propTypes = propTypes;

RightImageBox.defaultProps = defaultProps;

RightImageBox = WithUi(uiProps)(RightImageBox);
