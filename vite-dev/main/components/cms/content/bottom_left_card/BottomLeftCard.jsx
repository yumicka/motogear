...
class BottomLeftCard extends Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		return (
			<Fragment>
				...
				<EditContentForm name="bottom_left_card">
					{this.renderForm()}
				</EditContentForm>
			</Fragment>
		);
...
BottomLeftCard.propTypes = propTypes;

BottomLeftCard.defaultProps = defaultProps;

BottomLeftCard = WithUi(uiProps)(BottomLeftCard);
