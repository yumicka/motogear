//https://github.com/Pomax/react-onclickoutside/blob/master/src/index.js
...
export default function onClickOutsideHOC(WrappedComponent, config) {
	return class onClickOutside extends Component {
		static displayName = `OnClickOutside(${WrappedComponent.displayName ||
		...
		static defaultProps = {
			...
			outsideClickIgnoreClass:
				(config && config.outsideClickIgnoreClass) || IGNORE_CLASS_NAME,
