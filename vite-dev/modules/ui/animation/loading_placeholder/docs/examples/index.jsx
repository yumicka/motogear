...
const links = [];
const url = `${config.baseName}/animation/loading_placeholder`;
export const data = {};

import BasicExample, { info as BasicExampleInfo } from './basic';
dataExtract({ info: BasicExampleInfo, links, data, url });

import TypeExample, { info as TypeExampleInfo } from './type';
dataExtract({ info: TypeExampleInfo, links, data, url });
