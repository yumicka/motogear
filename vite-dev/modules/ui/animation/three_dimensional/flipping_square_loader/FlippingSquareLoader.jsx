...
import styles from "./FlippingSquareLoader.module.less";
...
class FlippingSquareLoader extends Component {
  constructor(props) {
    super(props);
  }
...
FlippingSquareLoader.propTypes = propTypes;

FlippingSquareLoader.defaultProps = defaultProps;
