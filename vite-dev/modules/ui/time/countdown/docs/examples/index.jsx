...
const links = [];
const url = `${config.baseName}/time/countdown`;
export const data = {};

import BasicExample, { info as BasicExampleInfo } from './basic';
dataExtract({ info: BasicExampleInfo, links, data, url });

import OnFinishCallbackExample, {
	info as OnFinishCallbackExampleInfo,
} from './on_finish_callback';
dataExtract({ info: OnFinishCallbackExampleInfo, links, data, url });
