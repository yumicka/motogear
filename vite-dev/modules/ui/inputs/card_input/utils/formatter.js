...
export const hasCardNumberReachedMaxLength = (
	...
	if (cardType) {
		return currentValueLength >= cardType.maxCardNumberLength;
	}

	return currentValueLength >= 19;
};
...
export const formatExpiry = prevExpiry => {
	...
	// 		console.log('return expiry[0]', expiry[0]);
	// 		return expiry[0];
	// 	}
	// 	if (/\d{2}/.test(expiry)) {
	// 		console.log('`${expiry[0]} / `', `${expiry[0]} / `);
	// 		return `${expiry[0]} / `;
	// 	}
	// }
