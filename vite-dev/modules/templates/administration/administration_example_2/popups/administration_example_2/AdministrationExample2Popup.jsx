...
const containerName = 'AdministrationExample2';
const popupName = 'administration_example_2';
const tableName = 'dt_administration_example_2';
const url = 'administration_example/administration_example_2/actions';
...
class AdministrationExample2Popup extends Component {
	constructor(props) {
		super(props);
...
AdministrationExample2Popup.propTypes = propTypes;

AdministrationExample2Popup.defaultProps = defaultProps;

export default AdministrationExample2Popup;
