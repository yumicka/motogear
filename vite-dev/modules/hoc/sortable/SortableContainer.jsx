...
const hoc = (WrappedComponent) => {
	class WithSortableContainer extends Component {
		static displayName = `WithSortableContainer(${getDisplayName(
			WrappedComponent,
		)})`;
		...
		handleStart = (event) => {
			//<editor-fold defaultstate="collapsed" desc="handleStart">
		...
		nodeIsChild = (node) => {
			//<editor-fold defaultstate="collapsed" desc="nodeIsChild">
			return node.sortableInfo.manager === this.manager;
			//</editor-fold>
		};

		handleMove = (event) => {
			//<editor-fold defaultstate="collapsed" desc="handleMove">
		...
		handleEnd = () => {
			//<editor-fold defaultstate="collapsed" desc="handleEnd">
			this.touched = false;
			this.cancel();
			//</editor-fold>
		};
		...
		handlePress = async (event) => {
			//<editor-fold defaultstate="collapsed" desc="handlePress">
			...
			if (active) {
				...
				if (isFunction(modifyHelper)) {
					modifyHelper({ helper: this.helper, node });
				}
		...
		handleSortMove = (event) => {
			//<editor-fold defaultstate="collapsed" desc="handleSortMove">
		...
		handleSortEnd = (event) => {
			//<editor-fold defaultstate="collapsed" desc="handleSortEnd">
		...
		updateHelperPosition(event) {
			//<editor-fold defaultstate="collapsed" desc="updateHelperPosition">
			const {
				lockAxis,
				lockOffset,
		...
		animateNodes() {
			//<editor-fold defaultstate="collapsed" desc="animateNodes">
		...
		autoscroll = () => {
			//<editor-fold defaultstate="collapsed" desc="autoscroll">
		...
		onAutoScroll = (offset) => {
			//<editor-fold defaultstate="collapsed" desc="onAutoScroll">
		...
		getContainer() {
			...
			return getContainer({ SortableContainer: this });
			//</editor-fold>
		}
		...
		keyLift = (event) => {
			//<editor-fold defaultstate="collapsed" desc="keyLift">
			const { target } = event;
		...
		keyMove = (shift) => {
			//<editor-fold defaultstate="collapsed" desc="keyMove">
			const nodes = this.manager.getOrderedRefs();
		...
		keyDrop = (event) => {
			//<editor-fold defaultstate="collapsed" desc="keyDrop">
		...
		handleKeyEnd = (event) => {
			//<editor-fold defaultstate="collapsed" desc="handleKeyEnd">
			if (this.manager.active) {
				this.keyDrop(event);
			}
			//</editor-fold>
		...
		isValidSortingTarget = (event) => {
			//<editor-fold defaultstate="collapsed" desc="isValidSortingTarget">
			const { useDragHandle } = this.props;
			const { target } = event;
			const node = closest(target, (el) => el.sortableInfo != null);
		...
		get helperContainer() {
			//<editor-fold defaultstate="collapsed" desc="helperContainer">
		...
		get containerScrollDelta() {
			//<editor-fold defaultstate="collapsed" desc="containerScrollDelta">
			const { useWindowAsScrollContainer } = this.props;
		...
		get windowScrollDelta() {
			//<editor-fold defaultstate="collapsed" desc="windowScrollDelta">
			return {
	...
	WithSortableContainer.propTypes = propTypes;

	WithSortableContainer.defaultProps = defaultProps;
